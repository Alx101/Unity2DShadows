...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'WebGL20.data';
    var REMOTE_PACKAGE_BASE = 'WebGL20.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3539762;
      var PACKAGE_UUID = 'c6f4c8fd-af8a-4897-b0ff-c18ffdd52349';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 607921, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(607921, 607940, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(607940, 2015444, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2015444, 3512136, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3512136, 3539762, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_WebGL20.data');

    };
    Module['addRunDependency']('datafile_WebGL20.data');
